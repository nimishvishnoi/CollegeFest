            ...
            <div class="row">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="no-scroll" href="test.php">Register</a></li>
                        <li><a class="no-scroll" href="gallery.php">Gallery</a></li>
                        <li class="active"><a class="scroll" href="#live">Live</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<section id="live" class="nimi">
    <div class="container">
    <div class="row text-center">
        <div class="video">
        <iframe width="1024" height="720" src="https://www.youtube.com/embed/Xbi03u4tjTI" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
    </div>
</section>
